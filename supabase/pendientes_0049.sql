-- ======================================================================
--  PENDIENTE: 0049 - el gasto de la IA, contado por LLAVE
--
--  Pegar entero y ejecutar. Se puede correr dos veces sin romper nada.
--  Anade una columna a ia_gasto y rehace ia_gasto_resumen().
--
--  DESPLEGAR TAMBIEN LA FUNCION DEL ASISTENTE: es la que escribe la
--  columna nueva. Sin ella, las filas salen sin llave y el informe las
--  agrupa por accion, como antes: no se rompe nada, solo no separa.
-- ======================================================================
