...
--
--  Es la migracion 0043. Se puede volver a ejecutar sin romper nada: todo
--  va con "create or replace".
--
--  Añade buscar a quien inscribir en Plan escribiendo su NOMBRE, en vez de
--  tener que teclear el correo exacto en un prompt del navegador.
--
--  COMPROBAR DESPUES (como entrenador, debe devolver a los tuyos):
